...
if __name__ == '__main__':
    ...
    for threshold in range(1,2):
        ...
        x1_f_train, x1_f_test, y1_f_train, y1_f_test = train_test_split(x1_f, y1_f, test_size=0.3, random_state=20)
        x2_f_train, x2_f_test, y2_f_train, y2_f_test = train_test_split(x2_f, y2_f, test_size=0.3, random_state=20)
        x3_f_train, x3_f_test, y3_f_train, y3_f_test = train_test_split(x3_f, y3_f, test_size=0.3, random_state=20)
        x4_f_train, x4_f_test, y4_f_train, y4_f_test = train_test_split(x4_f, y4_f, test_size=0.3, random_state=20)
        x5_f_train, x5_f_test, y5_f_train, y5_f_test = train_test_split(x5_f, y5_f, test_size=0.3, random_state=20)
        x1_o_train, x1_o_test, y1_o_train, y1_o_test = train_test_split(x1_o, y1_o, test_size=0.3, random_state=20)
        x5_o_train, x5_o_test, y5_o_train, y5_o_test = train_test_split(x5_o, y5_o, test_size=0.3, random_state=20)
        ...
        x_train = np.concatenate((x1_train,x2_train,x3_train,x4_train,x5_train,x1_f_train,x2_f_train,x3_f_train,x4_f_train,x5_f_train,x1_o_train,x5_o_train))
        x_test = np.concatenate((x1_test,x2_test,x3_test,x4_test,x5_test,x1_f_test,x2_f_test,x3_f_test,x4_f_test,x5_f_test,x1_o_test,x5_o_test))
        y_train = np.concatenate((y1_train,y2_train,y3_train,y4_train,y5_train,y1_f_train,y2_f_train,y3_f_train,y4_f_train,y5_f_train,y1_o_train,y5_o_train))
        y_test = np.concatenate((y1_test,y2_test,y3_test,y4_test,y5_test,y1_f_test,y2_f_test,y3_f_test,y4_f_test,y5_f_test,y1_o_test,y5_o_test))
        y_train = np_utils.to_categorical(y_train,num_classes=5)
        y_test = np_utils.to_categorical(y_test,num_classes=5)
        filepath = '/home/daisy001/mountdir/qihaoyang/cnn_finetune-master_/model/resnet50_'+time.strftime("%m-%d",time.localtime())+'_all_5classes'
