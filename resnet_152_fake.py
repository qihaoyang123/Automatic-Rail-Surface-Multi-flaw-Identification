...
def resnet50_model(img_rows, img_cols, color_type=1, num_classes=None):
    ...
    x_fc = Flatten()(x_fc)
    x_fc = Dense(6, activation='softmax', name='fc1000')(x_fc)
    ...
    if K.image_dim_ordering() == 'th':
      ...
      weights_path = 'model/resnet50_02-27_all'
...
if __name__ == '__main__':
    ...
    for threshold in range(1,2):
        ...
        filepath = '/home/daisy001/mountdir/qihaoyang/cnn_finetune-master_/model/resnet50_'+time.strftime("%m-%d",time.localtime())+'_all_fake'
